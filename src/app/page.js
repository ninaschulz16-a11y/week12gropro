...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#F5F5DC]">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-700 mb-8">
              Connect with neighbours to share items, find local help, and build community - all within walking distance.
            </p>
            <Link 
              href="/sign-up" 
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <h2 className="text-3xl font-bold text-[#3E513E] mb-12">How It Works</h2>
        
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-sm">
            <span className="text-4xl font-bold text-[#3E513E]">01</span>
            <h3 className="text-xl font-semibold text-gray-800 mt-4 mb-2">Sign Up</h3>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-4 mb-2">Post or Browse</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-4 mb-2">Connect</h3>
            <p className="text-gray-600">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="relative h-64 rounded-2xl overflow-hidden">
            <div className="w-full h-full bg-[#3E513E] rounded-2xl flex items-center justify-center p-8">
              <p className="text-white text-lg text-center">neighbourhood image</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-[#3E513E] text-white py-8 mt-16">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-sm mt-2 opacity-80">connecting communities, one neighbour at a time</p>
        </div>
      </footer>
    </div>
  );
